...
type SourceValidation = { valid: boolean; errors: string[]; warnings: string[]; summary?: { services?: string[]; images?: string[]; ports?: string[]; volumes?: string[]; networks?: string[]; secrets?: string[]; configs?: string[]; environment_variables?: Array<{ name: string; default_value?: string; required?: boolean; secret?: boolean; services?: string[] }> } };
